function [thetalist, success] = IKinBody(Blist, M, T,eomg, ev)
...
%mat=[];
%for j = 1:4000
%thetalist0 = [(rand*pi/2);(rand*pi/2);(rand*pi/2);(rand*pi/2);(rand*pi/2);(rand*pi/2)];
thetalist0 = [-3.14;0.068;0.068;0.068;0;-1.57];
%error = 0;
...
normVel
normAng
%total_error = [total_error;err thetalist0'];
