function [thetalist, success,error] = IKinBody(Blist, M, T, eomg, ev)
...
thetalist0 = [(rand*pi*2);(rand*pi*2);(rand*2*pi);(rand*2*pi);(rand*pi/2);(rand*2*pi)];    
%thetalist0=[2.048;0.341;-0.478;3.208;1.092;1.570]
%thetalist0=[1;1.5;2;3;4;5]
%thetalist0 = [2.389;0.956 ;  -1.911;4.027 ; 0.819 ;1.707];
